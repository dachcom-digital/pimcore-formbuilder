...
pimcore.registerNS('Formbuilder.extjs.conditionalLogic.action.toggleElement');
Formbuilder.extjs.conditionalLogic.action.toggleElement = Class.create(Formbuilder.extjs.conditionalLogic.action.abstract, {
