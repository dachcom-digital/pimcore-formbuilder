...
pimcore.registerNS('Formbuilder.comp.conditionalLogic.action.toggleAvailability');
Formbuilder.comp.conditionalLogic.action.toggleAvailability = Class.create(Formbuilder.comp.conditionalLogic.action.abstract, {
