...
interface DynamicOptionsTransformerInterface
{
     ...
     */
    public function transform(mixed $rawData, mixed $transformedData, ?array $optionConfig = null): array;

    /**
     * Transform symfony choices array into valid ExtJs Array.
     */
    public function reverseTransform(mixed $rawData, mixed $transformedData, ?array $optionConfig = null): array;
}
