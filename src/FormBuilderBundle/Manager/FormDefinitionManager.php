...
class FormDefinitionManager
{
    ...
    public function updateFields(array $data, FormDefinitionInterface $form)
    {
        $order = 0;
        $fields = [];
    ...
    protected function getValue($data, string $value, $default = null)
    {
        return $data[$value] ?? $default;
    }

    protected function getValueAsString($data, string $value, $default = '')
    {
        $val = $this->getValue($data, $value, $default);
