...
class FormHtml5File extends \Zend_View_Helper_FormElement
{
    ...
    public function formHtml5File($name, $value = NULL, $attribs = NULL, $options = NULL, $listsep = '')
    {
        ...
        $messages = ['core' => $coreMessages, 'delete' => $deleteMessages, 'text' => $interfacesText];

        return $this->view->partial('formbuilder/form/elements/html5file/default.php',
            ['fieldName' => $attribs['realName'], 'required' => $attribs['uploadIsRequired'], 'message' => $messages, 'sizeLimit' => $sizeLimit, 'allowedExtensions' => $allowedExtensions]);
    }
}