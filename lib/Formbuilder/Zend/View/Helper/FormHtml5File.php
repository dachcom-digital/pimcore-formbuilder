...
class FormHtml5File extends \Zend_View_Helper_FormElement
{
    public function formHtml5File($name, $value = null, $attribs = null, $options = null, $listsep = '')
    {
        ...
        return $this->view->partial('formbuilder/form/elements/html5file/default.php', array( 'fieldName' => $attribs['realName'], 'required' => $attribs['uploadIsRequired'], 'message' => $messages, 'sizeLimit' => $sizeLimit, 'allowedExtensions' => $allowedExtensions ));
    }
}